...
//{
//public:
//    void imagine2(double lungime, int nivel, CPunct p, CVector v, double d)
//    {
//        CPunct p1;
//        CPunct p2;
//        printf("nivel: %d\n", nivel);
...
//        else
//        {
//            /*imagine2(lungime * d, nivel - 1, p, v, d);*/
//
//            v.rotatie(-45);
//            v.deseneaza(p, lungime);
//            p1 = v.getDest(p, lungime);
//            imagine2(lungime * d, nivel - 1, p1, v, d);
//
//
//            v.rotatie(90);
//            v.deseneaza(p, lungime);
...
//        v.deseneaza(p, 0.16);
//        p = v.getDest(p, 0.16);
//        imagine2(lungime, nivel, p, v, 0.5);
//    }
//};
//
//class Imagine1{
...
//        if (nivel == 0)
//        {
//            v.deseneazaPatrat(p, lungime);
//        }
//        else
//        {   
//            imagine1(lungime, nivel - 1, p, v);
//            for (int i = 1;i <= 8;i++) {
//                v.rotatie(45*i);
//                if (i % 2 == 1) {
...
//                }
//                v.rotatie(-45 * i);
//                imagine1(lungime/3, nivel - 1, p1, v);
//            }
//            
//        }
//    }
...
//        CPunct p(0.0, 0.0);
//
//        v.deseneazaPatrat(p, 1.5);
//        imagine1(lungime, nivel, p, v);
//    }
//};
//
//
