...
//			if (z1 == z0)
//			{
//				// x nu apartine m.MB deoarece procesul iterativ converge finit
//				rez = -1;
//				break;
//			}
//			else if (z1.getModul() > m.modmax)
//			{
//				// x nu apartine m.MB deoarece procesul iterativ converge la 2
//				rez = 1;
//				break;
//			}
//			z0 = z1;
...
//				}
//				else {
//					glColor3f(0, 0.1 * (float)r, 0.1 * (float)r);
//					glVertex2d(x, y);
//				}
//			}
//		fprintf(stdout, "STOP\n");
